Justin W. Flory; Fedora community :page-authors: {author}, {author_2}
...
4.0)]({license-image}){#legal}

All content in the Fedora Community Architecture website is shared under
the {license-legal}\[Creative Commons Attribution 4.0 International (CC
BY 4.0) license\].
...
Roseline Bassey; Fedora community :page-authors: {author}, {author_2}
