...
If you find errors or have suggestions for improvement, we want your advice. Open an issue at https://gitlab.com/fedora/docs/fedora-linux-documentation/release-notes/-/issues.
