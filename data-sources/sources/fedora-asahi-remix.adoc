...
= Running x86/x86-64 applications on {variant-name}
...
=== What is {variant-name}'s relationship with Fedora KDE, Fedora Workstation, and Fedora Server?
...
=== Is {variant-name} safe to install and use?
