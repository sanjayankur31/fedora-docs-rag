...
# Create a Fedora Account {#fedora-account}
...
# How To Use Weblate {#_how_to_use_weblate}
...
## Introduction to Weblate {#_introduction_to_weblate}
...
## Login to Weblate {#_login_to_weblate}
...
## Weblate User Interface {#_weblate_user_interface}
...
## Translation hints and tips {#_translation_hints_and_tips}
...
# What Is Transtats? {#_what_is_transtats}
...
## Track Translations {#_track_translations}

### How to see the translation status of a package? {#_how_to_see_the_translation_status_of_a_package}
...
#### Login to add a new package {#_login_to_add_a_new_package}
...
### How to see the translation status of a language? {#_how_to_see_the_translation_status_of_a_language}
...
### How to see the translation status of a territory? {#_how_to_see_the_translation_status_of_a_territory}
...
## Create Reports {#_create_reports}
...
## Localization pipeline {#_localization_pipeline}
...
## Translation repositories {#_translation_repositories}

### Design rationale {#_design_rationale}
...
### Project creation {#_project_creation}

TBD

# Translation Projects in Weblate {#_translation_projects_in_weblate}
...
## Fedora's online translation platform {#_fedoras_online_translation_platform}
...
## Project configuration good practice {#_project_configuration_good_practice}
