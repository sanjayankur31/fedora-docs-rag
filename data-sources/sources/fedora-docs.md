...
meetings. = Communication and Meetings
...
discussion threads with actions, agreements, etc. = The Docs Workflow
organization Fedora Documentation Team
...
- Contributing to existing documentation = Contributing to existing
  documentation
...
Thanks for your contribution! = How to use GitLab UI for more involved
document maintenance Fedora Documentation Team
<https://discussion.fedoraproject.org/tag/docs-team>
...
Thanks for your contributions. = How to edit files on the Pagure Web UI
Hanku Lee
...
(Adam Šamalík) on the IRC channel and ask him about it. = How to Create
and Use a Local Fedora Documentation Workflow Fedora Documentation Team
<https://discussion.fedoraproject.org/tag/docs-team> :page-pagination:
...
Select Create merge request. = Building a local preview Fedora
...
Check Your Documentation Using Vale Fedora Documentation Team
...
:   Use [Vale](contributing-docs/tools-vale-linter.xml) to check your
    work to make sure it conforms to the Red Hat Style Guide. = AsciiDoc
    for Fedora Documentation Writers Fedora Documentation Team
...
AsciiDoc markup Fedora Documentation Team
<https://discussion.fedoraproject.org/tag/docs-team> v1.0, 2022-12-10
:page-toclevels: 3 :page-pagination:
...
The relevant sections provide further information. = Design & UX
contributions
