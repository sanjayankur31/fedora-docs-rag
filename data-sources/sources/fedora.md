...
# Changes in Fedora rawhide For Desktop Users {#_changes_in_fedora_rawhide_for_desktop_users_2}

# Changes in Fedora rawhide For Developers {#_changes_in_fedora_rawhide_for_developers_2}
...
## Providing Feedback on Fedora Software {#_providing_feedback_on_fedora_software_2}
...
## Providing Feedback on Release Notes {#_providing_feedback_on_release_notes_2}
...
## Recommended System Configuration {#_recommended_system_configuration_2}
...
# Changes in Fedora rawhide For System Administrators {#_changes_in_fedora_rawhide_for_system_administrators_2}
...
## We want feedback {#_we_want_feedback}

[]{.indexterm primary="feedback"
secondary="contact information for this manual"} If you find errors or
have suggestions for improvement, we want your advice. Open an issue at
<https://gitlab.com/fedora/docs/fedora-linux-documentation/release-notes/-/issues>.

In the issue:

1.  Provide a short summary of the error or your suggestion in the
    &#96;Issue Title&#96; field.

2.  Copy the following template into the &#96;Comment&#96; field and
    give us the details of the error or suggestion as specifically as
    you can. If possible, include some surrounding text so we know where
    the error occurs or the suggestion fits.
