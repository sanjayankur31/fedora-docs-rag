...
- Members and Governance Stephen Daley, Peter Boy
...
- Tickets: pagure.io/fedora-server Stephen Daley; Peter Boy
...
make it to a meeting, they can pre-vote via the mailing list. Peter Boy,
Stephen Daley :page-authors: {author}
...
:   - ***Essentials at a glance***
    ...
    - ***Actions summary***
      ...
      3.  eseyman will try to contact the maintainers and get
          information why the change was made. Stephen Daley; Peter Boy
...
7.  Check if you are on the branch you intend to work on

    \[...\]\$ git branch main \* stg

8.  If not, switch to the branch you want to use.
...
9.  Before your begin to work update your working directory

    \[...\]\$ git commit -m \"\<YOUR COMMIT MESSAGE\>\"

10. Modify content

11. Update preview and check:

    \[...\]\$ ./docsbuilder.sh

    Preview in your browser using the address *\'localhost:8080*

12. Repeat step 4 & 5 as required.
...
5.  In your browser open <https://pagure.io/fedora-server>, login,
    switch to your fork and create a pull request. Peter Boy (pboy)
...
4.  Ensure, that the source, usually main, is your currently active
    branch
...
7.  Create a new branch und switch to it at the same time
...
6.  Check whether a merge is possible without any problems.
