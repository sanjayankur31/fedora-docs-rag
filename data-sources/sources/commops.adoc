...
Discussions and planning take place in Matrix channel https://matrix.to/#/#commops:fedoraproject.org while our monthly team meetings are held in a meeting room such as https://matrix.to/#/#meeting:fedoraproject.org/.
