...
To request an exception link:++https://forge.fedoraproject.org/epel/steering++[open an issue]
...
\&#42; File a ticket in the link:++https://forge.fedoraproject.org/epel/steering++[EPEL issue tracker] indicating why you wish to
become a member.
...
\&#42; Look through link:++https://forge.fedoraproject.org/epel/steering++[the general EPEL issues] related to packaging and see where you can help.
...
. File an link:++https://forge.fedoraproject.org/epel/steering++[EPEL issue]. This can be done while
...
link:++https://forge.fedoraproject.org/epel/steering++[EPEL ticketing system].
