...
take maintainership of the Spin. \* Development Releases
...
- Upcoming Releases :release-version: 43
...
- Supported Releases :release-version: 42
...
guidance on how to give nudges.
...
a.  Add the new release to the [Changes wiki
    page](https://fedoraproject.org/wiki/Changes)
...
2.  Update the index.html page on the [web
    view](https://fedorapeople.org/groups/schedule/) of the schedule.
    Publish the changes using the [instructions for the schedule git
    repo](pgm_guide/schedule.xml#_git_repo).

3.  Update the releases docs
...
5.  Update the table in [Friday's Fedora
...
9.  Run `make` in the directory where the `fridays_fedora_facts.md` file
    lives. This will generate HTML that you can copy and paste into
    WordPress.

10. Title the post \"Friday's Fedora Facts: \<YYYY\>-\<WW\>\", where
    \<YYYY\> is the year and \<WW\> is the week of the year. The command
    `date +%Y-%V` will give you the correct date stamp.

11. Copy the HTML and convert to blocks.

12. Add a \"More\" element below the table of contents.

13. Set the category to \"Program Management\".

14. Add the following tags: \"releases\", \"Fedora release changeset\",
...
15. Set the featured image to be \"fpgm\" (a photo of a clipboard with
    the text \"From the Fedora Program Manager\") in the WordPress media
    library.

16. After publishing the update, remove outdated content from the
